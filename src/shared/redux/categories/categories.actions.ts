...
export const setCategories = (categories: ICategory[]): CategoriesAction<ICategory[]> => {
  return {
...
export const fetchCategoriesSuccess = (categories: ICategory[]): CategoriesAction<ICategory[]> => {
  return {
